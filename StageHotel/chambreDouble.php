...
<div class="text p-4" style="background-color: rgba(0,0,0,0.1);">
    <h4 class="mx-2">CHAMBRE DOUBLE</h4>
</div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="Images/ChambreDouble/chambreDouble1.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="Images/ChambreDouble/chambreDouble2.jpg" class="d-block w-100" alt="...">
                    </div>

                    <div class="carousel-item ">
                        <img src="Images/ChambreDouble/chambreDouble3.jpg" class="d-block w-100" alt="...">
                    </div>

                    <div class="carousel-item ">
                        <img src="Images/ChambreDouble/chambreDouble4.jpg" class="d-block w-100" alt="...">
                    </div>

                    <div class="carousel-item ">
                        <img src="Images/ChambreDouble/chambreDouble5.jpg" class="d-block w-100" alt="...">
                    </div>

                    <div class="carousel-item ">
                        <img src="Images/ChambreDouble/chambreDouble6.jpg" class="d-block w-100" alt="...">
                    </div>

                    <div class="carousel-item ">
                        <img src="Images/ChambreDouble/chambreDouble7.jpg" class="d-block w-100" alt="...">
                    </div>

                    <div class="carousel-item ">
                        <img src="Images/ChambreDouble/chambreDouble8.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
...
<div class="container p-3">
    ...
    <p>La Chambre Double est parfaite pour les couples. Elle est situé au rez-de-chaussée et est équipée de :</p>
    <ul>
        <li>
            Un lit double
        </li>
...
<div class="container">
    <table class="table table-bordered">
        <thead>
            <tr>
                <th scope="col" colspan="2" class="text-center">Chambre Double</th>
        ...
        <tbody>
            <tr>
                ...
                <td> <i class="fa-solid fa-check"></i> Dressing / <i class="fa-solid fa-check"></i> Chauffage / <i class="fa-solid fa-check"></i> Bureau / <i class="fa-solid fa-check"></i> Télévision à écran plat / <i class="fa-solid fa-check"></i> Service de reveil / <i class="fa-solid fa-check"></i> WI-FI / <i class="fa-solid fa-check"></i> Lit deux places</td>
